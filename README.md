...
```bash
wget -qO- https://raw.githubusercontent.com/NiuNiuIDC/realm-xwPF/main/xwPF.sh | sudo bash -s install
```

### 网络受限使用加速源,一键安装

```bash
wget -qO- https://v6.gh-proxy.org/https://raw.githubusercontent.com/NiuNiuIDC/realm-xwPF/main/xwPF.sh | sudo bash -s install
```
...
- **主脚本**：[xwPF.sh](https://github.com/NiuNiuIDC/realm-xwPF/raw/main/xwPF.sh)
- **模块文件**（全部需要）：https://github.com/NiuNiuIDC/realm-xwPF/tree/main/lib
